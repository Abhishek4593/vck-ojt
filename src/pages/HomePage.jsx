    ...
    return(
        ...
        <div className="page-container" style={{ overflow: "auto" }}>
                <div className="hero-section">
                    <img style={{width:"100%"}}    src="../Images/vck.1.jpg" alt=" collagename" 
            ...
            <img   src="/Images/vck3.jpg" alt=" collagename" height="350" width="700" /> <img    src="/Images/vck2.jpg" alt=" collagename"height="350" width="700" />
            </div>
